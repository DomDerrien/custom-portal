...
public class ServerErrorException extends javax.ws.rs.ServerErrorException {
    ...
    public ServerErrorException(Throwable cause) {
        ...
        logger.log(Level.FINEST,
                "Exception: " + getClass().getName() + " with cause: " + cause.getClass().getName() + " and cause message: " + cause.getMessage(), this);
    }

    public ServerErrorException(String message, Throwable cause) {
        super(message, Status.INTERNAL_SERVER_ERROR, cause);
        logger.log(Level.FINEST, "Exception: " + getClass().getName() + " with message: " + message + ", with cause: " + cause.getClass().getName()
                + ", and cause message: " + cause.getMessage(), this);
    }
}