...
public class MailConnector {
     ...
     * 
     * @param request
     *            Request parameters submitted by the Google App Engine in response to the reception of an mail message
     *            sent to a valid engine entry point
     * @return Extracted mail message information
     * 
     * @throws IOException
     *             If the HTTP request stream parsing fails
     */
    ...
    static {
        try {
            notifier = prepareInternetAddress("UTF8", "notifier@custom-portal.appspotmail.com", "notifier-noreply@custom-portal.appspotmail.com");
        }
     ...
     *             If the given email address is invalid
     */
     ...
     * @param subject
     *            Subject of the message that triggered this response
     * @param message
     *            Message to send
     * @param locale
     *            recipient's locale
     ...
     *             If one of the message attribute is incorrect
     * @throws UnsupportedEncodingException
     *             if the e-mail address is invalid
     */
    public static void sendMailMessage(String receiverId, String recipientName, String subject, String message, Locale locale) throws MessagingException,
    ...
    /**
     * Utility inserting the given text into the message as a multi-part segment with a plain text and a plain HTML
     * version
     * 
     * @param message
     *            Message container
     ...
     * 
     * @throws MessagingException
     *             If the submitted text is not accepted
     */
     ...
     * 
     * @param message
     *            MimeMessage or MimeBodyPart to study
     * @return Extracted piece of text (can be text/plain or text/HTML, on one or many lines)
     * 
     * @throws MessagingException
     *             When an error occurs while parsing a piece of the message
     * @throws IOException
     *             When an error occurs while reading the message stream
     */
    ...
    /**
     * Study the given MIME part to extract the first text content. Note that the algorithm excludes "text/*"
     * attachment. Note also that the algorithm does not parse recursively the "multipart/*" elements.
     * 
     * @param part
     *            Piece of content to study
     * @return Extracted text or empty string
     * 
     * @throws MessagingException
     *             When an error occurs while parsing a piece of the message
     ...
     * 
     * @throws IOException
     *             If the InputStream process fails
     */
    /*
     * // // Not used anymore since 1.2.8 because getContent() return String instance instead of InputStream //
     * protected static String convertToString(InputStream in) throws IOException { int character = in.read();
     * StringBuilder out = new StringBuilder(); while (character != -1) { out.append((char) character); character =
     * in.read(); } return LocaleValidator.toUTF8(out.toString()); }
     */
    ...
    public static void reportErrorToAdmins(String from, String subject, String body) throws MessagingException {
        ...
        // getLogger().warning("Reporting to 'admins' (medium: mail) -- subject: [" + messageToForward.getSubject() +
        // "] -- message: [" + body + "]");
     ...
     * 
     * @param message
     *            Message the system cannot decode
     * @return Decoded message
     * 
     * @throws MessagingException
     *             If the system cannot the message InputStream
     * @throws IOException
     *             If the message InputStream cannot be read one character at a time
     */
