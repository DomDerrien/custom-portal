    ...
    function(dojo, dom, win, construct, style, JSON) {
        ...
        var _init = function(params) {
            ...
            if (!dom.byId('notificationArea')) {
                ...
                construct.create('span', {
                    id: 'notificationAreaClose',
                    innerHTML: 'X'
                }, area);
                construct.create('img', {
                    id: 'notificationLevelIcon',
                }, area);
                construct.create('span', {
        ...
        var _handleXhrErrors = function(error) {
            ...
            switch (error.status) {
                case 201:
                    ...
                    break;
                case 400:
                    var payload = error.responseText,
                        violations, violationNb, idx, violation;
                    ...
                    break;
                case 404:
                    message = 'The requested information were not found.';
                    break;
                case 405:
                    message = 'The triggered action is not supported.';
                    break;
                case 500:
        ...
        var _showNotification = function(message, level, autoHide) {
            ...
            try {
                ...
                dojo.fadeIn({
                    onBegin: function() {
                        style.set('notificationArea', 'display', 'block');
                    },
                    node: 'notificationArea'
                }).play();
        ...
        var _hideNotificationArea = function() {
            ...
            dojo.fadeOut({
                node: 'notificationArea',
                onEnd: function() {
                    style.set('notificationArea', 'display', 'none');
                }
            }).play();
        };
