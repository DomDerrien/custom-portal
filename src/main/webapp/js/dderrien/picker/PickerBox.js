    ...
    function(dojo, template, _Widget, _TemplatedMixin, _WidgetsInTemplateMixin, PickerDialog) {
        ...
        var pickerBox = dojo.declare(
            [_Widget, _TemplatedMixin, _WidgetsInTemplateMixin], {
                ...
                _getHiddenNameAttr: function() {
                    return this.hiddenName;
                },
                _setHiddenNameAttr: function(value) {
                    this._set('hiddenName', value);
                },

                _getVisibleNameAttr: function() {
                    return this.visibleName;
                },
                _setVisibleNameAttr: function(value) {
                    this._set('visibleName', value);
                },

                _getStoreAttr: function() {
                    return this._pickerDialog.get('store');
                },
                _setStoreAttr: function(value) {
                    this._pickerDialog.set('store', value);
                },
